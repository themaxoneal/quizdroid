...
public class TopicQuiz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView ans1 = (TextView) rootView.findViewById(R.id.answer1);
        TextView ans2 = (TextView) rootView.findViewById(R.id.answer2);
        TextView ans3 = (TextView) rootView.findViewById(R.id.answer3);
        TextView ans4 = (TextView) rootView.findViewById(R.id.answer4);
